...
import io.github.magonxesp.bus.infrastructure.command.DispatchedCommand
...
class RabbitMqCommandBus(
	...
	override fun dispatch(command: Command<*>) {
		...
		//channel.basicPublish(exchangeName, commandHandler.routingKey, null, dispatchedCommand.serializeToJson().toByteArray())
	}
}
